require! <[chokidar http fs child_process path request]>
...
epa = (req, res) ->
  #url = \http://ww3.epa.gov.tw/getdatatable.asmx/Get_CaseHomeGis
  url = \http://cache.akprice.com.tw:8080/ev/getdatatable.asmx/Get_CaseHomeGis
  data = ""
  req.on \data (d) -> data += d
  req.on \end ->
    latlng = JSON.parse data
    post-data = {DateLv:'3', LON:latlng.lng,LAT:latlng.lat}
    request {url, method:\POST, json:post-data},  (e,r,b) ->
      data = JSON.parse b
