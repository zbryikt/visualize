...
var d1, ref$, unique, pairsToObj, sum, flatten, keys, d41, color, partyColor, constuiencyMap, loadHash, topo;
d1 = new Date();
  ...
  return d3.json('mly-8-with-sex.json', function(data){
    ...
    return d3.json('ttsinterpellation.compact.json', function(data){
      ...
      update = function(data){
        var d5, curSet, curNum, d51, x$, sex, d52, party, i$, ref$, len$, item, j$, ref1$, len1$, p, ref2$, radius, pie, arc, y$, z$, d53, constuiency, it, d54, askedBy, avg, k, v, z1$, d55, group, d6, x, ret, hrefHash;
        d5 = new Date();
        /*
        ...
        */
        ...
        if (!loadHash) {
          ...
          hrefHash = ret ? ret[1] : "";
          if (hrefHash) {
            return choose(askedByFilter, 'asked-by', hrefHash);
          }
        }
      };
